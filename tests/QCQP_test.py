...
def write_results(n: int = 1, p: int = 1, sample_num: int = 32, batch_size: int = 32, alg: str = "pyomo", val_seed: int = 0):
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1]:
        write_results(n=5, p=1, sample_num=20, batch_size=20, alg="pyomo", val_seed=0)
    else:
        test_grad()